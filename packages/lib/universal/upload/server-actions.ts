...
const getS3Client = () => {
  ...
  console.log('🚀 ~ getS3Client ~ env:', {
    NEXT_PUBLIC_UPLOAD_TRANSPORT: env('NEXT_PUBLIC_UPLOAD_TRANSPORT'),
    NEXT_PRIVATE_UPLOAD_ACCESS_KEY_ID: env('NEXT_PRIVATE_UPLOAD_ACCESS_KEY_ID'),
    NEXT_PRIVATE_UPLOAD_SECRET_ACCESS_KEY: env('NEXT_PRIVATE_UPLOAD_SECRET_ACCESS_KEY'),
    NEXT_PRIVATE_UPLOAD_ENDPOINT: env('NEXT_PRIVATE_UPLOAD_ENDPOINT'),
    NEXT_PRIVATE_UPLOAD_FORCE_PATH_STYLE: env('NEXT_PRIVATE_UPLOAD_FORCE_PATH_STYLE'),
    NEXT_PRIVATE_UPLOAD_REGION: env('NEXT_PRIVATE_UPLOAD_REGION'),
    NEXT_PRIVATE_UPLOAD_BUCKET: env('NEXT_PRIVATE_UPLOAD_BUCKET'),
  });
